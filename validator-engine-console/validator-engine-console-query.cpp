...
td::Status GetTimeQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_getTime>();
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}

td::Status GetTimeQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(f, ion::fetch_tl_object<ion::ion_api::engine_validator_time>(std::move(data), true),
...
td::Status NewKeyQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_generateKeyPair>();
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}

td::Status NewKeyQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(f, ion::fetch_tl_object<ion::ion_api::engine_validator_keyHash>(std::move(data), true),
                    "received incorrect answer: ");
...
td::Status ImportPrivateKeyFileQuery::send() {
  ...
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_importPrivateKey>(pk.tl());
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status ExportPublicKeyQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_exportPublicKey>(key_hash_.tl());
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}

td::Status ExportPublicKeyQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(f, ion::fetch_tl_object<ion::ion_api::PublicKey>(data.as_slice(), true),
                    "received incorrect answer: ");
...
td::Status SignQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_sign>(key_hash_.tl(), std::move(data_));
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}

td::Status SignQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(f, ion::fetch_tl_object<ion::ion_api::engine_validator_signature>(data.as_slice(), true),
                    "received incorrect answer: ");
...
td::Status SignFileQuery::send() {
  ...
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_sign>(key_hash_.tl(), std::move(data));
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status AddAdnlAddrQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_addAdnlId>(key_hash_.tl(), category_);
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}

td::Status AddAdnlAddrQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(f, ion::fetch_tl_object<ion::ion_api::engine_validator_success>(data.as_slice(), true),
                    "received incorrect answer: ");
...
td::Status AddDhtIdQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_addDhtId>(key_hash_.tl());
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status AddValidatorPermanentKeyQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_addValidatorPermanentKey>(
...
td::Status AddValidatorTempKeyQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_addValidatorTempKey>(
...
td::Status ChangeFullNodeAdnlAddrQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_changeFullNodeAdnlAddress>(key_hash_.tl());
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status AddValidatorAdnlAddrQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_addValidatorAdnlAddress>(
      perm_key_hash_.tl(), key_hash_.tl(), expire_at_);
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status AddLiteServerQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_addLiteserver>(key_hash_.tl(), port_);
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status DelAdnlAddrQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_delAdnlId>(key_hash_.tl());
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status DelDhtIdQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_delDhtId>(key_hash_.tl());
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status DelValidatorPermanentKeyQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_delValidatorPermanentKey>(key_hash_.tl());
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status DelValidatorTempKeyQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_delValidatorTempKey>(perm_key_hash_.tl(),
                                                                                               key_hash_.tl());
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status DelValidatorAdnlAddrQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_delValidatorAdnlAddress>(perm_key_hash_.tl(),
                                                                                                   key_hash_.tl());
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status GetConfigQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_getConfig>();
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}

td::Status GetConfigQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(f, ion::fetch_tl_object<ion::ion_api::engine_validator_jsonConfig>(data.as_slice(), true),
                    "received incorrect answer: ");
  td::TerminalIO::out() << "---------\n" << f->data_ << "--------\n";
  return td::Status::OK();
}
...
td::Status SetVerbosityQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_setVerbosity>(verbosity_);
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status GetStatsQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_getStats>();
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}

td::Status GetStatsQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(f, ion::fetch_tl_object<ion::ion_api::engine_validator_stats>(data.as_slice(), true),
                    "received incorrect answer: ");
...
td::Status AddNetworkAddressQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_addListeningPort>(
...
td::Status AddNetworkProxyAddressQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_addProxy>(
      static_cast<td::int32>(in_addr_.get_ipv4()), in_addr_.get_port(), static_cast<td::int32>(out_addr_.get_ipv4()),
      out_addr_.get_port(), ion::create_tl_object<ion::ion_api::adnl_proxy_fast>(id_, std::move(shared_secret_)),
...
td::Status CreateElectionBidQuery::send() {
  auto b =
      ion::create_serialize_tl_object<ion::ion_api::engine_validator_createElectionBid>(date_, elector_addr_, wallet_);
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}

td::Status CreateElectionBidQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(f, ion::fetch_tl_object<ion::ion_api::engine_validator_electionBid>(data.as_slice(), true),
                    "received incorrect answer: ");
...
td::Status CreateProposalVoteQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_createProposalVote>(td::BufferSlice(data_));
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}

td::Status CreateProposalVoteQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(f, ion::fetch_tl_object<ion::ion_api::engine_validator_proposalVote>(data.as_slice(), true),
                    "received incorrect answer: ");
...
td::Status CreateComplaintVoteQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_createComplaintVote>(election_id_,
...
td::Status CheckDhtServersQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_checkDhtServers>(id_.tl());
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}

td::Status CheckDhtServersQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(f, ion::fetch_tl_object<ion::ion_api::engine_validator_dhtServersStatus>(data.as_slice(), true),
                    "received incorrect answer: ");
...
td::Status SignCertificateQuery::send() {
  auto cid = ion::create_serialize_tl_object<ion::ion_api::overlay_certificateId>(overlay_, id_, expire_at_, max_size_);
  auto sign = ion::create_serialize_tl_object<ion::ion_api::engine_validator_sign>(signer_.tl(), std::move(cid));
  auto pub = ion::create_serialize_tl_object<ion::ion_api::engine_validator_exportPublicKey>(signer_.tl());
...
void SignCertificateQuery::receive_pubkey(td::BufferSlice R) {
  auto f = ion::fetch_tl_object<ion::ion_api::PublicKey>(R.as_slice(), true);
  if (f.is_error()) {
...
void SignCertificateQuery::receive_signature(td::BufferSlice R) {
  auto f = ion::fetch_tl_object<ion::ion_api::engine_validator_signature>(R.as_slice(), true);
  if(f.is_error()){
...
void SignCertificateQuery::save_certificate() {
  auto c = ion::create_serialize_tl_object<ion::ion_api::overlay_certificate>(
...
td::Status ImportCertificateQuery::send() {
  TRY_RESULT(data, td::read_file(in_file_));
  TRY_RESULT_PREFIX(cert, ion::fetch_tl_object<ion::ion_api::overlay_Certificate>(data.as_slice(), true),
                    "incorrect certificate");
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_importCertificate>(
                overlay_,
                ion::create_tl_object<ion::ion_api::adnl_id_short>(id_),
                ion::create_tl_object<ion::ion_api::engine_validator_keyHash>(kh_.tl()),
                std::move(cert)
           );
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
...
td::Status GetOverlaysStatsQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_getOverlaysStats>();
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}

td::Status GetOverlaysStatsQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(f, ion::fetch_tl_object<ion::ion_api::engine_validator_overlaysStats>(data.as_slice(), true),
                    "received incorrect answer: ");
  for (auto &s : f->overlays_) {
    ...
    auto print_traffic = [&](const char *name, const char *indent,
                             ion::tl_object_ptr<ion::ion_api::engine_validator_overlayStatsTraffic> &t) {
      sb << indent << name << ":\n"
...
td::Status SignShardOverlayCertificateQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_signShardOverlayCertificate>
             (wc_, shard_, ion::create_tl_object<ion::ion_api::engine_validator_keyHash>(key_.tl()), expire_at_, max_size_);
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}

td::Status SignShardOverlayCertificateQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(c, ion::fetch_tl_object<ion::ion_api::overlay_certificate>(data.as_slice(), true),
...
td::Status ImportShardOverlayCertificateQuery::send() {
  ...
  TRY_RESULT_PREFIX(cert, ion::fetch_tl_object<ion::ion_api::overlay_Certificate>(data.as_slice(), true),
                    "incorrect certificate");
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_importShardOverlayCertificate>
             (wc_, shard_, ion::create_tl_object<ion::ion_api::engine_validator_keyHash>(key_.tl()), std::move(cert));
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status GetActorStatsQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_getActorTextStats>();
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}

td::Status GetActorStatsQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(f, ion::fetch_tl_object<ion::ion_api::engine_validator_textStats>(data.as_slice(), true),
                    "received incorrect answer: ");
  if (file_name_.empty()) {
...
td::Status GetPerfTimerStatsJsonQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_getPerfTimerStats>("");
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}

td::Status GetPerfTimerStatsJsonQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(f, ion::fetch_tl_object<ion::ion_api::engine_validator_perfTimerStats>(data.as_slice(), true),
                    "received incorrect answer: ");
  std::ofstream sb(file_name_);
...
td::Status GetShardOutQueueSizeQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_getShardOutQueueSize>(
      dest_ ? 1 : 0, ion::create_tl_block_id_simple(block_id_), dest_ ? dest_.value().workchain : 0,
...
td::Status GetShardOutQueueSizeQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(f, ion::fetch_tl_object<ion::ion_api::engine_validator_shardOutQueueSize>(data.as_slice(), true),
                    "received incorrect answer: ");
...
td::Status SetExtMessagesBroadcastDisabledQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_setExtMessagesBroadcastDisabled>(value);
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status AddCustomOverlayQuery::send() {
  ...
  auto overlay = ion::create_tl_object<ion::ion_api::engine_validator_customOverlay>();
  TRY_STATUS(ion::ion_api::from_json(*overlay, json.get_object()));
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_addCustomOverlay>(std::move(overlay));
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status DelCustomOverlayQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_delCustomOverlay>(name_);
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status ShowCustomOverlaysQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_showCustomOverlays>();
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}

td::Status ShowCustomOverlaysQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(f, ion::fetch_tl_object<ion::ion_api::engine_validator_customOverlaysConfig>(data.as_slice(), true),
                    "received incorrect answer: ");
...
td::Status SetStateSerializerEnabledQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_setStateSerializerEnabled>(enabled_);
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status SetCollatorOptionsJsonQuery::send() {
  TRY_RESULT(data, td::read_file(file_name_));
  auto b =
      ion::create_serialize_tl_object<ion::ion_api::engine_validator_setCollatorOptionsJson>(data.as_slice().str());
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status ResetCollatorOptionsQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_setCollatorOptionsJson>("{}");
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status GetCollatorOptionsJsonQuery::send() {
  auto b =
      ion::create_serialize_tl_object<ion::ion_api::engine_validator_getCollatorOptionsJson>();
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status GetAdnlStatsJsonQuery::send() {
  auto b =
      ion::create_serialize_tl_object<ion::ion_api::engine_validator_getAdnlStats>(all_);
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}

td::Status GetAdnlStatsJsonQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(f, ion::fetch_tl_object<ion::ion_api::adnl_stats>(data.as_slice(), true),
                    "received incorrect answer: ");
...
td::Status GetAdnlStatsQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(stats, ion::fetch_tl_object<ion::ion_api::adnl_stats>(data.as_slice(), true),
                    "received incorrect answer: ");
  td::StringBuilder sb;
  sb << "================================= ADNL STATS =================================\n";
  bool first = true;
  ...
  for (auto &local_id : stats->local_ids_) {
    ...
    if (!local_id->current_decrypt_.empty()) {
      std::sort(local_id->current_decrypt_.begin(), local_id->current_decrypt_.end(),
                [](const ion::tl_object_ptr<ion::ion_api::adnl_stats_ipPackets> &a,
                   const ion::tl_object_ptr<ion::ion_api::adnl_stats_ipPackets> &b) {
    ...
    auto print_local_id_packets = [&](const std::string &name,
                                      std::vector<ion::tl_object_ptr<ion::ion_api::adnl_stats_ipPackets>> &vec) {
      if (vec.empty()) {
        return;
      }
    ...
    std::sort(local_id->peers_.begin(), local_id->peers_.end(),
              [](const ion::tl_object_ptr<ion::ion_api::adnl_stats_peerPair> &a,
                 const ion::tl_object_ptr<ion::ion_api::adnl_stats_peerPair> &b) {
    ...
    for (auto &peer : local_id->peers_) {
      ...
      auto print_packets = [&](const std::string &name,
                               const ion::tl_object_ptr<ion::ion_api::adnl_stats_packets> &obj) {
        if (obj->in_packets_) {
