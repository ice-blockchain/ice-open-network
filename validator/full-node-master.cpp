...
void FullNodeMasterImpl::process_query(adnl::AdnlNodeIdShort src, ion_api::ionNode_getNextBlockDescription &query,
...
void FullNodeMasterImpl::process_query(adnl::AdnlNodeIdShort src, ion_api::ionNode_prepareBlock &query,
                                       td::Promise<td::BufferSlice> promise) {
  auto P = td::PromiseCreator::lambda([promise = std::move(promise)](td::Result<BlockHandle> R) mutable {
    if (R.is_error()) {
...
void FullNodeMasterImpl::process_query(adnl::AdnlNodeIdShort src, ion_api::ionNode_downloadBlock &query,
                                       td::Promise<td::BufferSlice> promise) {
...
void FullNodeMasterImpl::process_query(adnl::AdnlNodeIdShort src, ion_api::ionNode_downloadBlockFull &query,
                                       td::Promise<td::BufferSlice> promise) {
...
void FullNodeMasterImpl::process_query(adnl::AdnlNodeIdShort src, ion_api::ionNode_downloadNextBlockFull &query,
                                       td::Promise<td::BufferSlice> promise) {
...
void FullNodeMasterImpl::process_query(adnl::AdnlNodeIdShort src, ion_api::ionNode_prepareBlockProof &query,
                                       td::Promise<td::BufferSlice> promise) {
...
void FullNodeMasterImpl::process_query(adnl::AdnlNodeIdShort src, ion_api::ionNode_prepareKeyBlockProof &query,
                                       td::Promise<td::BufferSlice> promise) {
  if (query.block_->seqno_ == 0) {
    promise.set_error(td::Status::Error(ErrorCode::protoviolation, "cannot download proof for zero state"));
    return;
...
void FullNodeMasterImpl::process_query(adnl::AdnlNodeIdShort src, ion_api::ionNode_downloadBlockProof &query,
                                       td::Promise<td::BufferSlice> promise) {
  auto P = td::PromiseCreator::lambda(
...
void FullNodeMasterImpl::process_query(adnl::AdnlNodeIdShort src, ion_api::ionNode_downloadBlockProofLink &query,
                                       td::Promise<td::BufferSlice> promise) {
  auto P = td::PromiseCreator::lambda(
      [promise = std::move(promise), validator_manager = validator_manager_](td::Result<BlockHandle> R) mutable {
        if (R.is_error()) {
...
void FullNodeMasterImpl::process_query(adnl::AdnlNodeIdShort src, ion_api::ionNode_downloadKeyBlockProof &query,
                                       td::Promise<td::BufferSlice> promise) {
  if (query.block_->seqno_ == 0) {
    promise.set_error(td::Status::Error(ErrorCode::protoviolation, "cannot download proof for zero state"));
    return;
...
void FullNodeMasterImpl::process_query(adnl::AdnlNodeIdShort src, ion_api::ionNode_downloadKeyBlockProofLink &query,
                                       td::Promise<td::BufferSlice> promise) {
  if (query.block_->seqno_ == 0) {
    promise.set_error(td::Status::Error(ErrorCode::protoviolation, "cannot download proof for zero state"));
    return;
...
void FullNodeMasterImpl::process_query(adnl::AdnlNodeIdShort src, ion_api::ionNode_prepareZeroState &query,
                                       td::Promise<td::BufferSlice> promise) {
  auto P =
...
void FullNodeMasterImpl::process_query(adnl::AdnlNodeIdShort src, ion_api::ionNode_preparePersistentState &query,
                                       td::Promise<td::BufferSlice> promise) {
  auto P =
      td::PromiseCreator::lambda([SelfId = actor_id(this), promise = std::move(promise)](td::Result<bool> R) mutable {
        if (R.is_error() || !R.move_as_ok()) {
...
void FullNodeMasterImpl::process_query(adnl::AdnlNodeIdShort src, ion_api::ionNode_getNextKeyBlockIds &query,
                                       td::Promise<td::BufferSlice> promise) {
...
void FullNodeMasterImpl::process_query(adnl::AdnlNodeIdShort src, ion_api::ionNode_downloadZeroState &query,
                                       td::Promise<td::BufferSlice> promise) {
  auto P = td::PromiseCreator::lambda(
...
void FullNodeMasterImpl::process_query(adnl::AdnlNodeIdShort src, ion_api::ionNode_downloadPersistentState &query,
                                       td::Promise<td::BufferSlice> promise) {
  auto P = td::PromiseCreator::lambda(
      [SelfId = actor_id(this), promise = std::move(promise)](td::Result<td::BufferSlice> R) mutable {
        if (R.is_error()) {
...
void FullNodeMasterImpl::process_query(adnl::AdnlNodeIdShort src, ion_api::ionNode_downloadPersistentStateSlice &query,
                                       td::Promise<td::BufferSlice> promise) {
  auto P = td::PromiseCreator::lambda(
      [SelfId = actor_id(this), promise = std::move(promise)](td::Result<td::BufferSlice> R) mutable {
        if (R.is_error()) {
...
void FullNodeMasterImpl::process_query(adnl::AdnlNodeIdShort src, ion_api::ionNode_getCapabilities &query,
                                       td::Promise<td::BufferSlice> promise) {
  promise.set_value(create_serialize_tl_object<ion_api::ionNode_capabilities>(proto_version(), proto_capabilities()));
}

void FullNodeMasterImpl::process_query(adnl::AdnlNodeIdShort src, ion_api::ionNode_getArchiveInfo &query,
                                       td::Promise<td::BufferSlice> promise) {
  auto P = td::PromiseCreator::lambda(
...
void FullNodeMasterImpl::process_query(adnl::AdnlNodeIdShort src, ion_api::ionNode_getArchiveSlice &query,
                                       td::Promise<td::BufferSlice> promise) {
...
void FullNodeMasterImpl::process_query(adnl::AdnlNodeIdShort src, ion_api::ionNode_slave_sendExtMessage &query,
                                       td::Promise<td::BufferSlice> promise) {
  ...
  promise.set_value(create_serialize_tl_object<ion_api::ionNode_success>());
}

void FullNodeMasterImpl::receive_query(adnl::AdnlNodeIdShort src, td::BufferSlice query,
                                       td::Promise<td::BufferSlice> promise) {
  auto BX = fetch_tl_prefix<ion_api::ionNode_query>(query, true);
  if (BX.is_error()) {
...
void FullNodeMasterImpl::start_up() {
  ...
  td::actor::send_closure(adnl_, &adnl::Adnl::subscribe, adnl_id_,
                          adnl::Adnl::int_to_bytestring(ion_api::ionNode_query::ID),
