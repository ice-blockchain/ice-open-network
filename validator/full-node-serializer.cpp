...
td::Result<td::BufferSlice> serialize_block_broadcast(const BlockBroadcast& broadcast, bool compression_enabled) {
  std::vector<tl_object_ptr<ion_api::ionNode_blockSignature>> sigs;
  for (auto& sig : broadcast.signatures) {
    sigs.emplace_back(create_tl_object<ion_api::ionNode_blockSignature>(sig.node, sig.signature.clone()));
  }
  if (!compression_enabled) {
    return create_serialize_tl_object<ion_api::ionNode_blockBroadcast>(
  ...
  td::BufferSlice data =
      create_serialize_tl_object<ion_api::ionNode_blockBroadcastCompressed_data>(std::move(sigs), std::move(boc));
  ...
  VLOG(FULL_NODE_DEBUG) << "Compressing block broadcast: "
                        ...
                        << compressed.size();
  return create_serialize_tl_object<ion_api::ionNode_blockBroadcastCompressed>(
      create_tl_block_id(broadcast.block_id), broadcast.catchain_seqno, broadcast.validator_set_hash, 0,
      std::move(compressed));
}

static td::Result<BlockBroadcast> deserialize_block_broadcast(ion_api::ionNode_blockBroadcast& f) {
...
static td::Result<BlockBroadcast> deserialize_block_broadcast(ion_api::ionNode_blockBroadcastCompressed& f,
                                                              int max_decompressed_size) {
  TRY_RESULT(decompressed, td::lz4_decompress(f.compressed_, max_decompressed_size));
  TRY_RESULT(f2, fetch_tl_object<ion_api::ionNode_blockBroadcastCompressed_data>(decompressed, true));
  std::vector<BlockSignature> signatures;
...
td::Result<BlockBroadcast> deserialize_block_broadcast(ion_api::ionNode_Broadcast& obj,
                                                       int max_decompressed_data_size) {
  td::Result<BlockBroadcast> B;
  ion_api::downcast_call(obj,
                         td::overloaded([&](ion_api::ionNode_blockBroadcast& f) { B = deserialize_block_broadcast(f); },
                                        [&](ion_api::ionNode_blockBroadcastCompressed& f) {
...
td::Result<td::BufferSlice> serialize_block_full(const BlockIdExt& id, td::Slice proof, td::Slice data,
  ...
  if (!compression_enabled) {
    return create_serialize_tl_object<ion_api::ionNode_dataFull>(create_tl_block_id(id), td::BufferSlice(proof),
  ...
  return create_serialize_tl_object<ion_api::ionNode_dataFullCompressed>(create_tl_block_id(id), 0,
                                                                         std::move(compressed), is_proof_link);
}

static td::Status deserialize_block_full(ion_api::ionNode_dataFull& f, BlockIdExt& id, td::BufferSlice& proof,
...
static td::Status deserialize_block_full(ion_api::ionNode_dataFullCompressed& f, BlockIdExt& id, td::BufferSlice& proof,
...
td::Status deserialize_block_full(ion_api::ionNode_DataFull& obj, BlockIdExt& id, td::BufferSlice& proof,
  ...
  ion_api::downcast_call(
      obj, td::overloaded(
               [&](ion_api::ionNode_dataFull& f) { S = deserialize_block_full(f, id, proof, data, is_proof_link); },
               [&](ion_api::ionNode_dataFullCompressed& f) {
...
td::Result<td::BufferSlice> serialize_block_candidate_broadcast(BlockIdExt block_id, CatchainSeqno cc_seqno,
  ...
  if (!compression_enabled) {
    return create_serialize_tl_object<ion_api::ionNode_newBlockCandidateBroadcast>(
        create_tl_block_id(block_id), cc_seqno, validator_set_hash,
        create_tl_object<ion_api::ionNode_blockSignature>(Bits256::zero(), td::BufferSlice()), td::BufferSlice(data));
  }
  ...
  return create_serialize_tl_object<ion_api::ionNode_newBlockCandidateBroadcastCompressed>(
      create_tl_block_id(block_id), cc_seqno, validator_set_hash,
      create_tl_object<ion_api::ionNode_blockSignature>(Bits256::zero(), td::BufferSlice()), 0, std::move(compressed));
}

static td::Status deserialize_block_candidate_broadcast(ion_api::ionNode_newBlockCandidateBroadcast& obj,
...
static td::Status deserialize_block_candidate_broadcast(ion_api::ionNode_newBlockCandidateBroadcastCompressed& obj,
                                                        BlockIdExt& block_id, CatchainSeqno& cc_seqno,
                                                        td::uint32& validator_set_hash, td::BufferSlice& data,
                                                        int max_decompressed_data_size) {
  block_id = create_block_id(obj.id_);
...
td::Status deserialize_block_candidate_broadcast(ion_api::ionNode_Broadcast& obj, BlockIdExt& block_id,
  ...
  ion_api::downcast_call(obj, td::overloaded(
                                  [&](ion_api::ionNode_newBlockCandidateBroadcast& f) {
                                    S = deserialize_block_candidate_broadcast(f, block_id, cc_seqno, validator_set_hash,
                                                                              data);
                                  },
                                  [&](ion_api::ionNode_newBlockCandidateBroadcastCompressed& f) {
                                    S = deserialize_block_candidate_broadcast(f, block_id, cc_seqno, validator_set_hash,
